...
#define controller_km 0
#define controller_roll 1
#define controller_pitch 2
#define controller_yaw 3
#define controller_full 4

#define communication_limit 10
...
volatile float km = 0.44;

volatile float kp_phi = 0.000;
volatile float kd_phi = 0.00;

volatile float kp_theta = 0.00;
volatile float kd_theta = 0.00;
volatile float ki_theta = 0.00; 

volatile float kp_psi = 0.000;
volatile float ki_psi = 0.00; 
volatile float kd_psi = 0.00;

volatile float phi_ref = 0.0;
volatile float theta_ref = 0.0;
volatile float psi_ref = 0.0;

volatile float phi_en = 0.0;
volatile float theta_en = 0.0;
volatile float psi_en = 0.0;

volatile bool reading = false;

volatile int controller = 0;

volatile int communication_counter = 0;

// 0 - Km
// 1 - Phi (Roll)
// 2 - Theta (Pitch)
// 3 - Psi (Yaw)
// 4 - Phi, Theta, Psi (Full)
