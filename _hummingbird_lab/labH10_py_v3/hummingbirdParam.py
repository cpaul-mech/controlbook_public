...
Tune_km = [[Frame_Km],
           [Frame_Encoder]]                             # Lab H4

Tune_Pitch = [[Frame_Km],
              [Frame_Pitch],
              [Frame_Encoder]]                          # Lab H7

Tune_Lat = [[Frame_Km,Frame_Action],
            [Frame_Roll, Frame_Yaw],
            [Frame_Encoder,Frame_Control]]              # Lab H8

Tune_Full = [[Frame_Empty,Frame_Km,Frame_Action_Full],
             [Frame_Roll, Frame_Pitch, Frame_Yaw],
             [Frame_Empty,Frame_Encoder,Frame_Control]] # Lab H10
